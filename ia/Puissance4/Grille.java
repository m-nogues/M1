...
public class Grille {
	 ...
	 * NOTE : il peut �tre int�ressant de changer l'ordre de g�n�ration
	 * des colonnes...
	 *
	...
	/**
	 * Fonction qui modifie la grille, apr�s que joueur ait jou� dans la
	 * colonne c.
	 *
	 * @param joueur
	 *          : le num�ro du joueur.
