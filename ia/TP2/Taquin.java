...
public class Taquin {
	...
	/**
	 * M�thode qui applique l'algorihtme A*, � partir de l'�tat intial donn� et
	 * en utilisant l'heuristique donn�e.
	 * 
	 * @param etatInit
	 *            : l'�tat initial.
	 * @param heurist
	 *            : l'heuristique utilis�e.
	 * @return l'�tat final.
	 */
	...
	public static void main(String[] args) {
		...
		int[][] tabInit1 = { { 2, 8, 3 }, { 1, 6, 4 }, { 7, 0, 5 } };

		int[][] tabInit2 = { { 2, 0, 4 }, { 1, 6, 3 }, { 7, 5, 8 } };
