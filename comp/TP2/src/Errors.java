 ...
 * the method name. Its parameters are useful for human readability. Error codes
 * are used by the test scripts and are chosen arbitrarily.
 *
 * @author aoliveir
 */
public class Errors {
	 ...
	 */
	static public void incompatibleTypes(CommonTree token, Object expectedType, Object actualType, String extra) {
		Util.printError(token, "E#INC_TYP: incompatible types: expected '" + expectedType + "', got '" + actualType
				+ "'" + addExtra(extra));
	}
	 ...
	 *            additional information to the error message, or null if none.
	 */
	static public void redefinedIdentifier(CommonTree token, String name, String extra) {
		Util.printError(token, "E#DEF_ID: redefined identifier: " + name + addExtra(extra));
	}
	 ...
	 *            additional information to the error message, or null if none.
	 */
	static public void unknownIdentifier(CommonTree token, String name, String extra) {
		Util.printError(token, "E#UNK_ID: unknown identifier: " + name + addExtra(extra));
	}
}
