// $ANTLR 3.5.2 ./src/VSLTreeParser.g 2016-11-08 10:03:34
...
public class VSLTreeParser extends TreeParser {
	...
	// $ANTLR start "proto"
	// ./src/VSLTreeParser.g:46:1: proto[SymbolTable ts] : ^( PROTO_KW type IDENT pl= param_list[ts, t] ) ;
	public final void proto(SymbolTable ts) throws RecognitionException {
		CommonTree IDENT7=null;
		Type type6 =null;

		try {
			// ./src/VSLTreeParser.g:47:2: ( ^( PROTO_KW type IDENT pl= param_list[ts, t] ) )
			// ./src/VSLTreeParser.g:47:4: ^( PROTO_KW type IDENT pl= param_list[ts, t] )
			{
			...
			ts.enterScope();
			pushFollow(FOLLOW_param_list_in_proto191);
			param_list(ts, t);
			state._fsp--;
		...
		try {
			...
			switch (alt3) {
				case 1 :
					...
					{
					match(input,INT_KW,FOLLOW_INT_KW_in_type214); 
					type_ret = Type.INT;
					}
					break;
				case 2 :
	...
	public final void param_list(SymbolTable ts, FunctionType type) throws RecognitionException {
		try {
			...
			{
			match(input,PARAM,FOLLOW_PARAM_in_param_list236); 
			if ( input.LA(1)==Token.DOWN ) {
				...
				while (true) {
					...
					case 1 :
						...
						{
						pushFollow(FOLLOW_param_in_param_list239);
						param(ts, type);
						state._fsp--;
		...
		try {
			...
			switch (alt5) {
				case 1 :
					...
					{
					IDENT8=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_param255); 
				...
				case 2 :
					...
					{
					match(input,ARRAY,FOLLOW_ARRAY_in_param265); 
					match(input, Token.DOWN, null); 
					IDENT9=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_param267); 
					match(input, Token.UP, null); 
		...
		try {
			...
			switch (alt7) {
				...
				case 2 :
					...
					{
					RETURN_KW12=(CommonTree)match(input,RETURN_KW,FOLLOW_RETURN_KW_in_statement307); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_expression_in_statement309);
				...
				case 3 :
					...
					{
					match(input,IF_KW,FOLLOW_IF_KW_in_statement321); 
					match(input, Token.DOWN, null); 
				...
				case 4 :
					...
					{
					match(input,WHILE_KW,FOLLOW_WHILE_KW_in_statement352); 
					match(input, Token.DOWN, null); 
				...
				case 5 :
					...
					{
					match(input,FCALL_S,FOLLOW_FCALL_S_in_statement371); 
					match(input, Token.DOWN, null); 
					IDENT13=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_statement373); 
					FunctionType t = new FunctionType(Type.VOID, false);
					pushFollow(FOLLOW_argument_list_in_statement377);
				...
				case 6 :
					...
					{
					match(input,PRINT_KW,FOLLOW_PRINT_KW_in_statement392); 
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						pushFollow(FOLLOW_print_list_in_statement394);
				...
				case 7 :
					...
					{
					match(input,READ_KW,FOLLOW_READ_KW_in_statement407); 
					if ( input.LA(1)==Token.DOWN ) {
						match(input, Token.DOWN, null); 
						pushFollow(FOLLOW_read_list_in_statement409);
		...
		try {
			...
			switch (alt8) {
				case 1 :
					...
					{
					IDENT17=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_statement_lhs442); 
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_array_elem_in_statement_lhs451);
		...
		try {
			...
			switch (alt9) {
				case 1 :
					...
					{
					match(input,PLUS,FOLLOW_PLUS_in_expression472); 
					match(input, Token.DOWN, null); 
				...
				case 2 :
					...
					{
					match(input,MINUS,FOLLOW_MINUS_in_expression493); 
					match(input, Token.DOWN, null); 
				...
				case 4 :
					...
					{
					match(input,DIV,FOLLOW_DIV_in_expression535); 
					match(input, Token.DOWN, null); 
				...
				case 5 :
					...
					{
					pushFollow(FOLLOW_primary_exp_in_expression557);
					pe=primary_exp(ts);
					state._fsp--;
	...
	// ./src/VSLTreeParser.g:182:1: primary_exp[SymbolTable ts] returns [ExpAttribute expAtt] : ( INTEGER | IDENT | ^( FCALL IDENT argument_list[ts, null] ) | array_elem[ts, null] | ^( NEGAT p= primary[ts] ) );
	public final ExpAttribute primary_exp(SymbolTable ts) throws RecognitionException {
		...
		try {
			// ./src/VSLTreeParser.g:183:2: ( INTEGER | IDENT | ^( FCALL IDENT argument_list[ts, null] ) | array_elem[ts, null] | ^( NEGAT p= primary[ts] ) )
			int alt10=5;
			switch ( input.LA(1) ) {
			case INTEGER:
				{
			...
			switch (alt10) {
				case 1 :
					...
					{
					INTEGER19=(CommonTree)match(input,INTEGER,FOLLOW_INTEGER_in_primary_exp577); 
				...
				case 2 :
					...
					{
					IDENT20=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_primary_exp586); 
				...
				case 3 :
					...
					{
					match(input,FCALL,FOLLOW_FCALL_in_primary_exp596); 
					match(input, Token.DOWN, null); 
					IDENT21=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_primary_exp598); 
					pushFollow(FOLLOW_argument_list_in_primary_exp600);
				...
				case 4 :
					...
					{
					pushFollow(FOLLOW_array_elem_in_primary_exp614);
					...
					break;
				case 5 :
					// ./src/VSLTreeParser.g:218:5: ^( NEGAT p= primary[ts] )
					{
					match(input,NEGAT,FOLLOW_NEGAT_in_primary_exp624); 
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_primary_in_primary_exp628);
					p=primary(ts);
					state._fsp--;
	...
	// $ANTLR start "primary"
	// ./src/VSLTreeParser.g:226:1: primary[SymbolTable ts] returns [ExpAttribute expAtt] : pe= primary_exp[ts] ;
	public final ExpAttribute primary(SymbolTable ts) throws RecognitionException {
		ExpAttribute expAtt = null;
		...
		try {
			// ./src/VSLTreeParser.g:227:2: (pe= primary_exp[ts] )
			// ./src/VSLTreeParser.g:227:4: pe= primary_exp[ts]
			{
			pushFollow(FOLLOW_primary_exp_in_primary653);
			pe=primary_exp(ts);
			state._fsp--;
	...
	// $ANTLR start "block"
	// ./src/VSLTreeParser.g:230:1: block[SymbolTable ts] returns [Code3a code] : ( ^( BLOCK decl_block= declaration[ts] inst_block= inst_list[ts] ) | ^( BLOCK inst_block2= inst_list[ts] ) );
	public final Code3a block(SymbolTable ts) throws RecognitionException {
		...
		try {
			// ./src/VSLTreeParser.g:231:2: ( ^( BLOCK decl_block= declaration[ts] inst_block= inst_list[ts] ) | ^( BLOCK inst_block2= inst_list[ts] ) )
			int alt11=2;
			...
			switch (alt11) {
				case 1 :
					// ./src/VSLTreeParser.g:231:4: ^( BLOCK decl_block= declaration[ts] inst_block= inst_list[ts] )
					{
					match(input,BLOCK,FOLLOW_BLOCK_in_block674); 
					ts.enterScope();
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_declaration_in_block680);
					decl_block=declaration(ts);
					state._fsp--;

					pushFollow(FOLLOW_inst_list_in_block685);
					...
					break;
				case 2 :
					// ./src/VSLTreeParser.g:237:4: ^( BLOCK inst_block2= inst_list[ts] )
					{
					match(input,BLOCK,FOLLOW_BLOCK_in_block697); 
					ts.enterScope();
					match(input, Token.DOWN, null); 
					pushFollow(FOLLOW_inst_list_in_block703);
	...
	// ./src/VSLTreeParser.g:244:1: declaration[SymbolTable ts] returns [Code3a code] : ^( DECL (di= decl_item[ts] )+ ) ;
	public final Code3a declaration(SymbolTable ts) throws RecognitionException {
		...
		try {
			...
			{
			match(input,DECL,FOLLOW_DECL_in_declaration732); 
			match(input, Token.DOWN, null); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_decl_item_in_declaration737);
					di=decl_item(ts);
					state._fsp--;
		...
		try {
			...
			switch (alt13) {
				case 1 :
					...
					{
					IDENT24=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_decl_item760); 
				...
				case 2 :
					...
					{
					match(input,ARDECL,FOLLOW_ARDECL_in_decl_item770); 
					match(input, Token.DOWN, null); 
					IDENT25=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_decl_item772); 
					INTEGER26=(CommonTree)match(input,INTEGER,FOLLOW_INTEGER_in_decl_item774); 
					match(input, Token.UP, null); 
	...
	// ./src/VSLTreeParser.g:276:1: inst_list[SymbolTable ts] returns [Code3a code] : ^( INST (st= statement[ts] )+ ) ;
	public final Code3a inst_list(SymbolTable ts) throws RecognitionException {
		...
		code = new Code3a();
		try {
			// ./src/VSLTreeParser.g:277:2: ( ^( INST (st= statement[ts] )+ ) )
			// ./src/VSLTreeParser.g:277:4: ^( INST (st= statement[ts] )+ )
			{
			match(input,INST,FOLLOW_INST_in_inst_list802); 
			match(input, Token.DOWN, null); 
			// ./src/VSLTreeParser.g:277:11: (st= statement[ts] )+
			int cnt14=0;
			loop14:
			while (true) {
				int alt14=2;
				...
				switch (alt14) {
				case 1 :
					// ./src/VSLTreeParser.g:277:12: st= statement[ts]
					{
					pushFollow(FOLLOW_statement_in_inst_list807);
					st=statement(ts);
					state._fsp--;
	...
	// ./src/VSLTreeParser.g:281:1: argument_list[SymbolTable ts, FunctionType t] returns [Code3a code] : ( expression[ts] )* ;
	public final Code3a argument_list(SymbolTable ts, FunctionType t) throws RecognitionException {
		...
		try {
			// ./src/VSLTreeParser.g:282:2: ( ( expression[ts] )* )
			// ./src/VSLTreeParser.g:282:4: ( expression[ts] )*
			{
			// ./src/VSLTreeParser.g:282:4: ( expression[ts] )*
			loop15:
			while (true) {
				...
				switch (alt15) {
				case 1 :
					// ./src/VSLTreeParser.g:282:5: expression[ts]
					{
					pushFollow(FOLLOW_expression_in_argument_list832);
	...
	// ./src/VSLTreeParser.g:295:1: print_list[SymbolTable ts] returns [Code3a code] : ( print_item[ts] )* ;
	public final Code3a print_list(SymbolTable ts) throws RecognitionException {
		...
		code = new Code3a();
		try {
			// ./src/VSLTreeParser.g:296:2: ( ( print_item[ts] )* )
			// ./src/VSLTreeParser.g:296:4: ( print_item[ts] )*
			{
			// ./src/VSLTreeParser.g:296:4: ( print_item[ts] )*
			loop16:
			while (true) {
				...
				if ( (LA16_0==DIV||LA16_0==IDENT||LA16_0==INTEGER||(LA16_0 >= MINUS && LA16_0 <= MUL)||LA16_0==PLUS||LA16_0==TEXT||LA16_0==ARELEM||LA16_0==FCALL||LA16_0==NEGAT) ) {
					alt16=1;
				}

				switch (alt16) {
				case 1 :
					// ./src/VSLTreeParser.g:296:5: print_item[ts]
					{
					pushFollow(FOLLOW_print_item_in_print_list864);
	...
	// ./src/VSLTreeParser.g:299:1: print_item[SymbolTable ts] returns [Code3a code] : ( TEXT | expression[ts] );
	public final Code3a print_item(SymbolTable ts) throws RecognitionException {
		...
		try {
			// ./src/VSLTreeParser.g:300:2: ( TEXT | expression[ts] )
			int alt17=2;
			...
			switch (alt17) {
				case 1 :
					// ./src/VSLTreeParser.g:300:4: TEXT
					{
					TEXT29=(CommonTree)match(input,TEXT,FOLLOW_TEXT_in_print_item887); 
	...
	// ./src/VSLTreeParser.g:304:1: read_list[SymbolTable ts] returns [Code3a code] : ( read_item[ts] )* ;
	public final Code3a read_list(SymbolTable ts) throws RecognitionException {
		...
		code = new Code3a();
		try {
			// ./src/VSLTreeParser.g:305:2: ( ( read_item[ts] )* )
			// ./src/VSLTreeParser.g:305:4: ( read_item[ts] )*
			{
			// ./src/VSLTreeParser.g:305:4: ( read_item[ts] )*
			loop18:
			while (true) {
	...
	// ./src/VSLTreeParser.g:308:1: read_item[SymbolTable ts] returns [Code3a code] : ( IDENT | array_elem[ts, null] );
	public final Code3a read_item(SymbolTable ts) throws RecognitionException {
		...
		try {
			// ./src/VSLTreeParser.g:309:2: ( IDENT | array_elem[ts, null] )
			int alt19=2;
	...
	// ./src/VSLTreeParser.g:322:1: array_elem[SymbolTable ts, ExpAttribute exp] returns [ExpAttribute expAtt] : ^( ARELEM IDENT expression[ts] ) ;
	...
	public static final BitSet FOLLOW_param_list_in_proto191 = new BitSet(new long[]{0x0000000000000008L});
	...
	public static final BitSet FOLLOW_PARAM_in_param_list236 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_param_in_param_list239 = new BitSet(new long[]{0x0000010000004008L});
	public static final BitSet FOLLOW_IDENT_in_param255 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ARRAY_in_param265 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_param267 = new BitSet(new long[]{0x0000000000000008L});
	...
	public static final BitSet FOLLOW_RETURN_KW_in_statement307 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_statement309 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_IF_KW_in_statement321 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_statement327 = new BitSet(new long[]{0x00002210C4008020L});
	public static final BitSet FOLLOW_statement_in_statement332 = new BitSet(new long[]{0x00002210C4008028L});
	public static final BitSet FOLLOW_statement_in_statement338 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_WHILE_KW_in_statement352 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_statement356 = new BitSet(new long[]{0x00002210C4008020L});
	public static final BitSet FOLLOW_statement_in_statement361 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_FCALL_S_in_statement371 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_statement373 = new BitSet(new long[]{0x0000908002C14208L});
	public static final BitSet FOLLOW_argument_list_in_statement377 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_PRINT_KW_in_statement392 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_print_list_in_statement394 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_READ_KW_in_statement407 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_read_list_in_statement409 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_block_in_statement422 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_statement_lhs442 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_array_elem_in_statement_lhs451 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_PLUS_in_expression472 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression476 = new BitSet(new long[]{0x0000908002C14200L});
	public static final BitSet FOLLOW_expression_in_expression481 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_MINUS_in_expression493 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression497 = new BitSet(new long[]{0x0000908002C14200L});
	...
	public static final BitSet FOLLOW_expression_in_expression518 = new BitSet(new long[]{0x0000908002C14200L});
	public static final BitSet FOLLOW_expression_in_expression523 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_DIV_in_expression535 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_expression_in_expression539 = new BitSet(new long[]{0x0000908002C14200L});
	public static final BitSet FOLLOW_expression_in_expression544 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_primary_exp_in_expression557 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_INTEGER_in_primary_exp577 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_IDENT_in_primary_exp586 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_FCALL_in_primary_exp596 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_primary_exp598 = new BitSet(new long[]{0x0000908002C14208L});
	public static final BitSet FOLLOW_argument_list_in_primary_exp600 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_array_elem_in_primary_exp614 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_NEGAT_in_primary_exp624 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_primary_in_primary_exp628 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_primary_exp_in_primary653 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_BLOCK_in_block674 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_declaration_in_block680 = new BitSet(new long[]{0x0000400000000000L});
	public static final BitSet FOLLOW_inst_list_in_block685 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_BLOCK_in_block697 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_inst_list_in_block703 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_DECL_in_declaration732 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_decl_item_in_declaration737 = new BitSet(new long[]{0x0000004000004008L});
	public static final BitSet FOLLOW_IDENT_in_decl_item760 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ARDECL_in_decl_item770 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_decl_item772 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_INTEGER_in_decl_item774 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_INST_in_inst_list802 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_statement_in_inst_list807 = new BitSet(new long[]{0x00002210C4008028L});
