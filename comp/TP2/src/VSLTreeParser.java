// $ANTLR 3.5.2 ./src/VSLTreeParser.g 2016-11-04 16:38:41
...
public class VSLTreeParser extends TreeParser {
	...
	public final Code3a declaration(SymbolTable ts) throws RecognitionException {
		...
		try {
			...
			{
			match(input,DECL,FOLLOW_DECL_in_declaration698); 
			match(input, Token.DOWN, null); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_decl_item_in_declaration703);
					di=decl_item(ts);
					state._fsp--;
		...
		try {
			...
			switch (alt13) {
				case 1 :
					...
					{
					IDENT24=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_decl_item726); 
				...
				case 2 :
					...
					{
					match(input,ARDECL,FOLLOW_ARDECL_in_decl_item736); 
					match(input, Token.DOWN, null); 
					IDENT25=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_decl_item738); 
					INTEGER26=(CommonTree)match(input,INTEGER,FOLLOW_INTEGER_in_decl_item740); 
					match(input, Token.UP, null); 
	...
	public final Code3a inst_list(SymbolTable ts) throws RecognitionException {
		...
		try {
			...
			{
			match(input,INST,FOLLOW_INST_in_inst_list768); 
			match(input, Token.DOWN, null); 
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_statement_in_inst_list773);
					st=statement(ts);
					state._fsp--;
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_expression_in_argument_list798);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_print_item_in_print_list830);
		...
		try {
			...
			switch (alt17) {
				case 1 :
					...
					{
					TEXT29=(CommonTree)match(input,TEXT,FOLLOW_TEXT_in_print_item853); 
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_expression_in_print_item863);
		...
		try {
			...
			while (true) {
				...
				case 1 :
					...
					{
					pushFollow(FOLLOW_read_item_in_read_list892);
		...
		try {
			...
			switch (alt19) {
				case 1 :
					...
					{
					IDENT32=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_read_item916); 
				...
				case 2 :
					...
					{
					pushFollow(FOLLOW_array_elem_in_read_item925);
					array_elem(ts, null);
					state._fsp--;
	...
	public final ExpAttribute array_elem(SymbolTable ts, ExpAttribute exp) throws RecognitionException {
		...
		try {
			...
			match(input, Token.DOWN, null); 
			IDENT33=(CommonTree)match(input,IDENT,FOLLOW_IDENT_in_array_elem950); 
			pushFollow(FOLLOW_expression_in_array_elem952);
	...
	public static final BitSet FOLLOW_DECL_in_declaration698 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_decl_item_in_declaration703 = new BitSet(new long[]{0x0000004000004008L});
	public static final BitSet FOLLOW_IDENT_in_decl_item726 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ARDECL_in_decl_item736 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_decl_item738 = new BitSet(new long[]{0x0000000000010000L});
	public static final BitSet FOLLOW_INTEGER_in_decl_item740 = new BitSet(new long[]{0x0000000000000008L});
	public static final BitSet FOLLOW_INST_in_inst_list768 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_statement_in_inst_list773 = new BitSet(new long[]{0x00002210C4008028L});
	public static final BitSet FOLLOW_expression_in_argument_list798 = new BitSet(new long[]{0x0000108002C14202L});
	public static final BitSet FOLLOW_print_item_in_print_list830 = new BitSet(new long[]{0x0000108202C14202L});
	public static final BitSet FOLLOW_TEXT_in_print_item853 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_expression_in_print_item863 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_read_item_in_read_list892 = new BitSet(new long[]{0x0000008000004002L});
	public static final BitSet FOLLOW_IDENT_in_read_item916 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_array_elem_in_read_item925 = new BitSet(new long[]{0x0000000000000002L});
	public static final BitSet FOLLOW_ARELEM_in_array_elem948 = new BitSet(new long[]{0x0000000000000004L});
	public static final BitSet FOLLOW_IDENT_in_array_elem950 = new BitSet(new long[]{0x0000108002C14200L});
	public static final BitSet FOLLOW_expression_in_array_elem952 = new BitSet(new long[]{0x0000000000000008L});
}
