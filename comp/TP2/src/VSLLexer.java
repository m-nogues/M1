...
public class VSLLexer extends Lexer {
	...
	public void mTokens() throws RecognitionException {
		// ./src/VSLLexer.g:1:8: ( WS | COMMENT | LP | RP | LB | RB | LC | RC |
		// COM | FUNC_KW | PROTO_KW | INT_KW | VOID_KW | ASSIGN_KW | RETURN_KW |
		// PRINT_KW | READ_KW | IF_KW | THEN_KW | ELSE_KW | FI_KW | WHILE_KW |
		// DO_KW | OD_KW | PLUS | MINUS | MUL | DIV | IDENT | TEXT | INTEGER )
		int alt5 = 31;
		switch (input.LA(1)) {
			case '\t':
			case '\n':
			...
			case 'F': {
				...
				if (LA5_10 == 'U')
					...
					try {
						input.consume();
						NoViableAltException nvae = new NoViableAltException("", 5, 10, input);
						throw nvae;
					} finally {
			...
			case 'P': {
				...
				if (LA5_11 == 'R') {
					...
					if (LA5_30 == 'O')
						...
						try {
							for (int nvaeConsume = 0; nvaeConsume < 3 - 1; nvaeConsume++)
								input.consume();
							NoViableAltException nvae = new NoViableAltException("", 5, 30, input);
							throw nvae;
						} finally {
							input.rewind(nvaeMark);
						}
					...
					try {
						input.consume();
						NoViableAltException nvae = new NoViableAltException("", 5, 11, input);
						throw nvae;
					} finally {
						input.rewind(nvaeMark);
					}
			...
			case 'I': {
				...
				if (LA5_12 == 'N')
					...
					try {
						input.consume();
						NoViableAltException nvae = new NoViableAltException("", 5, 12, input);
						throw nvae;
					} finally {
						input.rewind(nvaeMark);
					}
				...
				if (LA5_15 == 'E') {
					...
					if (LA5_33 == 'T')
						...
						try {
							for (int nvaeConsume = 0; nvaeConsume < 3 - 1; nvaeConsume++)
								input.consume();
							NoViableAltException nvae = new NoViableAltException("", 5, 33, input);
							throw nvae;
						} finally {
							input.rewind(nvaeMark);
						}
					...
					try {
						input.consume();
						NoViableAltException nvae = new NoViableAltException("", 5, 15, input);
						throw nvae;
					} finally {
						input.rewind(nvaeMark);
					}
			...
			case 'D': {
				...
				if (LA5_19 == 'O') {
					...
					try {
						input.consume();
						NoViableAltException nvae = new NoViableAltException("", 5, 19, input);
						throw nvae;
					} finally {
						input.rewind(nvaeMark);
					}
