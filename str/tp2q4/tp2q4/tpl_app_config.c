 ...
 * Automatically generated by goil on Tue Feb 14 18:07:15 2017
 * from root OIL file tp2q4.oil
 *
...
/* Event e1 */
#define e1_mask 1
CONST(EventMaskType, AUTOMATIC) e1 = e1_mask;
...
/* Alarm a1 identifier */
#define a1_id 0
CONST(AlarmType, AUTOMATIC) a1 = a1_id;

/* Alarm a2 identifier */
#define a2_id 1
CONST(AlarmType, AUTOMATIC) a2 = a2_id;

/* Alarm a3 identifier */
#define a3_id 2
CONST(AlarmType, AUTOMATIC) a3 = a3_id;
...
CONST(tpl_tick, OS_CONST) OSMAXALLOWEDVALUE = 5000;
...
/*
 * Event structure of task task4
 */
VAR(tpl_task_events, OS_VAR) task4_task_evts = {
  /* event set  */ 0,
  /* event wait */ 0
};
...
CONST(tpl_task_activation_action, OS_CONST) a1_action = {
  {
...
CONST(tpl_alarm_static, OS_CONST) a1_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , a1_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a1_action
};
...
VAR(tpl_time_obj, OS_VAR) a1_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a1_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  1000,
    /* date                         */  100,
...
CONST(tpl_task_activation_action, OS_CONST) a2_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  task2_id
...
CONST(tpl_alarm_static, OS_CONST) a2_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , a2_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a2_action
};
...
VAR(tpl_time_obj, OS_VAR) a2_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a2_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  3000,
    /* date                         */  100,
...
CONST(tpl_task_activation_action, OS_CONST) a3_action = {
  {
    /* action function  */  tpl_action_activate_task
  },
  /* task id            */  task3_id
...
CONST(tpl_alarm_static, OS_CONST) a3_static = {
  {
    /* pointer to counter           */  &SystemCounter_counter_desc,
    /* pointer to the expiration    */  tpl_raise_alarm
#if (WITH_TRACE == YES)
    /* id of the alarm for tracing  */  , a3_id
#endif
#if WITH_OSAPPLICATION == YES
    /* OS application id            */  , 
#endif
  },
  /* action of the alarm  */  (tpl_action *)&a3_action
};
...
VAR(tpl_time_obj, OS_VAR) a3_alarm_desc = {
    /* pointer to the static part   */  (tpl_time_obj_static *)&a3_static,
    /* next alarm                   */  NULL,
    /* prev alarm                   */  NULL,
    /* cycle                        */  2000,
    /* date                         */  100,
...
VAR(tpl_proc_id, OS_VAR) tpl_priority_5_fifo[12];
