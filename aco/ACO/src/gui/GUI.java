...
public final class GUI extends JFrame implements Observer, ActionListener {
	...
	public GUI(final EditionEngine moteur) {
		...
		((AbstractDocument) zoneTexte.getDocument())
				.setDocumentFilter(filtreModifs);
		...
		coller.setIcon(
				new ImageIcon(getClass().getResource("/icones/coller.png")));
		copier.setIcon(
				new ImageIcon(getClass().getResource("/icones/copier.png")));
		couper.setIcon(
				new ImageIcon(getClass().getResource("/icones/couper.png")));
		supprimer.setIcon(
				new ImageIcon(getClass().getResource("/icones/supprimer.png")));
