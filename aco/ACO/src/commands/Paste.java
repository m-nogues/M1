...
/**
 * La commande Paste ordonne à l'implémentation du engine d'édition d'effectuer
 * une opération de collage.
 */
public final class Paste implements Command {
	/** The Constant LOGGER. */
	private static final Logger	LOGGER	= LogManager
			.getLogger(Paste.class.getName());
	 ...
	 *            the moteur
	 */
	public Paste(EditionEngine moteur) {
		/* Préconditions */
		if (moteur == null)
	...
	public final void execute() {
		LOGGER.trace("On exécute une commande Paste");
		moteur.paste();
	}
}
